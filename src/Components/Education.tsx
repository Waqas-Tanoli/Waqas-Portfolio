...
const Education = () => {
  ...
  return (
    <section id="education" className="py-20 px-4 bg-zinc-900">
      <div className="container mx-auto max-w-6xl">
        <motion.h2
          ...
          className="text-4xl md:text-5xl font-bold text-center text-zinc-100 mb-16"
        >
            ...
            {educationList.map((edu, index) => (
              ...
              >
                ...
                >
                  {/* Timeline marker */}
                  <div
                    className="absolute top-1/2 -translate-y-1/2 w-4 h-4 rounded-full bg-amber-500 border-4 border-zinc-900 z-10 group-hover:scale-150 transition-transform duration-300"
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                      ...
                      <div className="flex flex-col items-end gap-1">
                        <span className="text-xs px-3 py-1 bg-amber-500/20 text-amber-400 rounded-full">
                          {edu.currentlyStudying ? "Current" : "Completed"}
                        </span>
